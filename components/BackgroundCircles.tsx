...
export default function BackgroundCircles({}: Props) {
  return (
    ...
    className='relative flex justify-center items-center'>
        ...
        <div className='rounded-full border border-yellow-400 rounded-full h-[650px] w-[650px] mt-52 animate-pulse absolute opacity-20' />
        <div className='rounded-full border border-neutral-800 rounded-full h-[800px] w-[800px] mt-52 absolute' />
        <div className='absolute border border-yellow-400 rounded-full h-[500px] w-[500px] mt-52 animate-ping opacity-100' />
    </motion.div>
  )
}
            ...
            <div className='flex flex-col space-y-10'>
                ...
                <div className='space-y-10'>
                    ...
                    <PhoneIcon className='text-[#8b9d63] h-7 w-7 animate-pulse' />
                        <Link href='tel:+14387381828' className='text-2xl'>+1438-7381828 </Link>
                        
                    </div>
                    
                    <div className='flex items-center justify-center space-x-5'>
                    <EnvelopeIcon className='text-[#8b9d63] h-7 w-7 animate-pulse' />
                        <Link href='mailto:cedric.productmanager@gmail.com?subject=Hi from your website' className='text-2xl'>cedric.productmanager@gmail.com</Link>
                    </div>
                </div>

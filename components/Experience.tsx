...
export default function Experience({}: Props) {
  return (
    ...
    <div className='w-full flex space-w-5 space-x-10  overflow-x-scroll p-10 snap-x snap-mandatory scrollbar scrollbar-thin scrollbar-track-gray-400/20 scrollbar-thumb-[#8b9d63]/80'>

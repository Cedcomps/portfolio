...
interface Experience {
  ...
  const experiencesData: Experience[] = [
    ...
    },
    {
      ...
      techs: ["https://icon.icepanel.io/Technology/png-shadow-512/Linux.png", "https://icon.icepanel.io/Technology/png-shadow-512/Microsoft-SQL-Server.png", "https://icon.icepanel.io/Technology/svg/Windows-8.svg"],
      date: "2011 - 2016",
